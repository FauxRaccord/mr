    ...
    private async searchKeywords(keywords: string[]) {
        ...
        for (const item of rawData) {
            ...
            for (const keyword of keywords) {
                ...
                const authorMatch = regex.exec(result.author);
                regex.lastIndex = 0;            /// Reset regex
                ...
                if (authorMatch) {
                    result.author = result.author.replace(regex, Search.marker);
                }
        ...
        return <article>
            <a href={item.permalink}>
                <div class="article-details">
                    <h3 class="article-title" dangerouslySetInnerHTML={{ __html: item.title }}></h3>
                    <h4 class="article-author" dangerouslySetInnerHTML={{ __html: item.author}}></h4>
